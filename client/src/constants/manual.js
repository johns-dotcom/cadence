...
export const MANUAL_SECTIONS = [
  ...
  { path: '/my-work', group: 'Getting started', title: 'My Work', depts: ['Operations', 'Executive'],
    summary: 'Your tasks as a switchable database — Board, Table, Calendar or List — plus a "Waiting on you" rail.',
    steps: [
      'Switch views with the Board / Table / Calendar / List buttons, or press 1–4.',
      'Group by status, priority, due date or category, then filter and sort — the counts in every group header follow.',
      'Drag cards to reorder them, or across columns to change whatever you grouped by. Manual sort must be active to drag.',
      'In Table view click any cell to edit it in place; press Z to undo the last edit (20 deep).',
      'Tick rows to select them, then set status, priority, due date or assignee for the whole selection at once.',
      'Save the current view (filters, grouping, columns and all) under a name — it follows you to any device.',
  ...
  { path: '/team-work', group: 'Getting started', title: 'Team Work', depts: ['Operations', 'Executive'],
    ...
    steps: [
      ...
      'Click anyone\'s row to drop into a board filtered to just their tasks.',
      'Group by assignee and drag a card between columns to hand work over — the new assignee gets an email.',
      'Select several tasks to rebalance them in one go.',
    ],
    tips: [
      { roles: ['Superadmin', 'Admin'], text: 'You see every task in the workspace, and can group by department.' },
      { roles: ['Approver'], text: 'You see your own department. Editing and reassigning is limited to your team — ask an admin to change someone\'s department on the Team page.' },
    ] },

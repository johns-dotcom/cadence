...
export const MANUAL_SECTIONS = [
  ...
  { path: '/usage', group: 'Workspace', title: 'Usage analytics', depts: ['Executive'],
    summary: 'How your team is using the workspace — views, active users, most-used pages.',
    steps: ['Pick a date range and review the daily activity chart and leaderboards.'] },
  { path: '/data-quality', group: 'Workspace', title: 'Data quality', depts: ['Operations'],
    summary: 'Find and merge duplicate releases, artists, and vendors.',
    steps: ['Review flagged duplicates and merge the keepers.'] },

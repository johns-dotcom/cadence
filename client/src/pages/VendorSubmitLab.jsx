...
// INTERNAL LAB — signed-in, admin-gated, rendered inside the app shell at
...
export default function VendorSubmitLab() {
  ...
  const draftKey = `vendorform-lab:${slug}`
  ...
  if (done) return <SandboxReport result={done} onReset={submitAnother} />
